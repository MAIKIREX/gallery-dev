import StackingCardsSection from "@/components/gsap/stacking-cards"
import Link from "next/link"
import { ArrowLeft } from "lucide-react"

export default function GsapStackingPreviewPage() {
  return (
    <main className="min-h-screen bg-slate-950">
      ...
      <div className="h-screen bg-slate-950 flex flex-col items-center justify-center border-t border-white/10">
        <p className="text-slate-400 text-lg">Fin de la animación Stacking Cards.</p>
        <p className="text-slate-500 mt-2">Observa cómo cada tarjeta se fijó (pin) en su momento exacto.</p>
      </div>
    </main>
  )
}
